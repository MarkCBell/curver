...
\begin{tikzpicture}[scale=2, thick]
    ...
    \draw [Gray, dotted] (-1, -0.01) to [out=0,in=0] (-1, 1);
    \draw [Gray, dotted] (2, -0.01) to [out=0,in=0] (2, 1);
    ...
    % Front curves:
    % Alpha.
    \draw [red] (-3, -0.15) to [out=180,in=180] (-3, -1) node [below] {$a_0$};
    \draw [red] (-1, -0.15) to [out=180,in=180] (-1, -1) node [below] {$a_1$};
    \draw [red] (2, -0.15) to [out=180,in=180]  (2, -1) node [below] {$a_{g-1}$};
    ...
    \draw [Gray] (-1, -0.01) to [out=180,in=180] (-1, 1) node [above] {\outline{$d_{1}$}};
    \draw [Gray] (2, -0.01) to [out=180,in=180] (2, 1) node [above] {\outline{$d_{g-1}$}};
